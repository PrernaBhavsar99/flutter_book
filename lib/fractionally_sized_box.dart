...
class FractionalSizedBoxWidget extends StatefulWidget {
  const FractionalSizedBoxWidget({Key? key}) : super(key: key);
  static const route = "/fractionallySizedBox";

  @override
  _FractionalSizedBoxWidgetState createState() =>
      _FractionalSizedBoxWidgetState();
}

class _FractionalSizedBoxWidgetState extends State<FractionalSizedBoxWidget> {
